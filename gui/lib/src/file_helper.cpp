...
#define RELATIVE {"../../","","../../../gui/","../../gui/","../../../","gui/"} //Change this line based on the current working directory. More specifically, please APPEND instead of REMOVE items from the list.
